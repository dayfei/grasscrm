...
<body>
  <div id="feature">
    <div id="shortcuts" class="headerList">
      ...
      <span style="white-space:nowrap;">
        <a id="select" href="#" class="easyui-linkbutton" iconCls="icon-search" plain="true" onClick="openwindow('/crm/selectContactPage.action?relationKey=TargetList&relationValue=<s:property value="id" />','Select Contact',750,500)"><s:text name="action.select" /></a>  
      </span>	      		     		     
    </div> 		 
