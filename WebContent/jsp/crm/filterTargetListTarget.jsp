...
<body>
  <div id="feature">
    <div id="shortcuts" class="headerList">
      ...
      <span style="white-space:nowrap;">
        <a id="select" href="#" class="easyui-linkbutton" iconCls="icon-search" plain="true" onClick="openwindow('/crm/selectTargetPage.action?relationKey=TargetList&relationValue=<s:property value="id" />','Select Target',750,500)"><s:text name="action.select" /></a>  
      </span>	      		     		     
    </div> 		 
